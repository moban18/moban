...
<div id="main" class="clearfix">
    ...
    <div class="goods_show_box">
        <div id="goods_show">
            ...
            <div class="goods_sbreadcrumbs">
                ...
                <span>&gt;</span>
                <a href="/moban/index.php/Home/Svip/index/filter/<?php echo ($attr['id']); ?>-0-0-0-0-0">
                <?php echo ($attr['attr_name']); ?>
                </a>
                <span>&gt;</span>
                <a href="/moban/index.php/Home/Svip/index/filter/<?php echo ($searchs[0]['attrter_id']); ?>-0-0-0-0-0" target="_blank">
 ...
 $b='【原创】'; $a=strpos($info['goods_name'],$b); $c=substr($info['goods_name'],0,$a); ?>
                            ...
                            <p class="info clearfix">
                                <span class="fr">来源：<?php echo ($_SERVER["SERVER_NAME"]); ?>/moban/index.php/Home/Svip/content/id/<?php echo ($info["id"]); ?></span>
 ...
 if($store){ echo 'like_status'; }?>
                    ...
                    <div class="template_feature">
                        <span class="feature">
                            分类：<a href="/moban/index.php/Home/Svip/index/filter/<?php echo ($attr['id']); ?>-0-0-0-0-0">
                <?php echo ($attr['attr_name']); ?>
                </a>
                            &gt; <a href="/moban/index.php/Home/Svip/index/filter/<?php echo ($searchs[0]['attrter_id']); ?>-0-0-0-0-0">
                    <?php if($searchs){ echo $searchs[0]['attr_name']; }?>
                </a></span>
                        <span class="feature">
                            ...
                            布局：
                            <a href="/moban/index.php/Home/Svip/index/filter/0-0-<?php echo ($v['attrter_id']); ?>-0-0-0" target="_blank">
                        ...
                        <span class="feature">
                            ...
                            <a href="/moban/index.php/Home/Svip/index/filter/0-<?php echo ($v['attrter_id']); ?>-0-0-0-0" target="_blank"><?php echo $v['attr_name'];?></a>&nbsp;
                            <?php endif;endforeach;?>
                        </span>
    ...
    <script>
        ...
        function downloadZipBox(){
            ...
            $.ajax({
                type:'post',
                url:'/moban/index.php/Home/Svip/getLoad',
                data:{
                    viptype:viptype,
