        ...
        <div class="AreaR">
            <div class="AreaR_box">
                <div class="AreaR_box_1">
                    <div class="clearfix">
                        <h5><span
                                style="font-size: 20px;display: block;margin-bottom:10px;border-bottom:1px solid #DDDDDD;color:#F67F45">充值/消费记录</span>
                        </h5>
                        <div class="blank"></div>
                        <div class="oper_nav">
                            <ul id="userinfo">
                                <li><a href="/moban/index.php/Home/User/buy" class="user_active">会员升级/充值金币</a></li>
                                <li><a href="/moban/index.php/Home/User/myorder">我的下载</a></li>
                            </ul>
                        ...
                        <div class="oper_box">
                            ...
                            <span class="order_info">详细状态信息</span>
                            <span class="order_studus">状态</span>
                            <span class="order_time">时间</span>

                        </div>
                        <div class="oper_info">
                            <?php if(is_array($buys)): $i = 0; $__LIST__ = $buys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><ul class="oper_list">
                                    <li class="oper_id"><?php echo ($v["buy_id"]); ?></li>
                                    <?php if($v['vip_id'] != ''): ?><li class="oper_product"><?php echo ($v['vip_name']); ?></li>
                                        <?php else: ?>
                                        <li class="oper_product"><?php echo ($v['jbin_type']); ?>金币</li><?php endif; ?>
                                    <li class="oper_info1">
                                        <?php if($v['vip_id'] != ''): ?>会员升级
                                            <?php else: ?>
                                            金币充值<?php endif; ?>

                                    </li>
                                    <li class="oper_studus">
                                        <?php if($v['buy_success'] == 0): ?>未付款
                                            <?php else: ?>
                                            已付款<?php endif; ?>

                                    </li>

                                    <li class="oper_time"><?php echo date('Y-m-d',$v['buy_time']);?></li>
