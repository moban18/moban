        ...
        <div id="content" class="content clearfix">
            <div id="list" class="list">
                <div class="list_box clearfix">
                    ...
                    <div class="goods_box">
                        <a href="/moban/index.php/Home/<?php echo ($v['cate_url']); ?>/content/id/<?php echo ($v['id']); ?>"><img src="/moban/<?php echo ($v['goods_photo']); ?>" alt=""/></a>
                        <p class="goods_title">
            ...
            <div class="page_list clearfix">
                共 <span class="tatle"><?php echo ($count); ?></span> 个网站模板
                ...
                <?php if(!I('p')):?>
                  ...
                  <?php elseif(I('p')<=1):?>
                   javascript:vode(0);
                   <?php else:?>
                   /moban/index.php/Home/Index/search/?keywords=<?php echo I('keywords');?>&cate_id=<?php echo I('cate_id');?>&p=<?php echo I('p')-1;?>
                <?php endif;?>
                        " class="pre">上一页</a>
                <?php for($i=0;$i<$pages;$i++):?>
                <a class="
                <?php if(I('p')==$i+1){ echo 'current'; }else{ echo 'num'; } ?>
                        " href="/moban/index.php/Home/Index/search/?keywords=<?php echo I('keywords');?>&cate_id=<?php echo I('cate_id');?>&p=<?php echo ($i+1); ?>"><?php echo $i+1?></a>
                <?php endfor;?>
                <a href="
                <?php if(I('p')>=$pages):?>
                    javascript:vode(0);
