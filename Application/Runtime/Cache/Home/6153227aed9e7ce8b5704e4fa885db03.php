        ...
        <div class="contain_box ">
            <div class="contain_top clearfix">
                ...
                <div class="contain_nav">
                    ...
                    <a href="/moban/index.php/Home/Study">建站小识</a>
                </div>
                ...
                <div class="research">
                    <form action="/moban/index.php/Home/Study/articleSearch" method="post">
                        <div class="research_box">
                            ...
                            <input name="s" type="text" class="research_input" placeholder="请输入搜索内容" />
                ...
                <div class="mail2">
                                ...
                                <div class="contain_left_center clearfix">
                                    <div class="center_box_top">
                                        <div class="center_box_top_left">
                                            <a href="/moban/index.php/Home/Study/index/cate/<?php echo ($v['id']); ?>" alt=""><?php echo ($v['cate_name']); ?></a>>
                    ...
                    <div class="contain_page">
                        <div class="contain_page_box clearfix">
                            ...
                            <div class="page_left">
                                <!--上一页开始-->
                                    <?php if(I('p')>1): $pre=I('p')-1; $reach=I('article_research'); ?>
                                    <div class="article_pre">
                                        <a href="/moban/index.php/Home/Study/articleSearch/s/<?php echo ($s); ?>/p/<?php echo ($pre); ?>" title="上一页">上一页</a>
                                    </div>
                                    <?php endif;?>
                                <!--上一页结束-->
                                <!--数字页码开始-->
                                <?php for($i=0;$i<$pages;$i++): if($i<=9): ?>
                                    <a href="/moban/index.php/Home/Study/articleSearch/s/<?php echo ($s); ?>/p/<?php echo ($i+1); ?>" class="
                                ...
                                <!--数字页码结束-->
                                <!--下一页开始-->
                                    <?php if(I('p')<$pages): $nex=I('p')+1; ?>
                                    <div class="article_nex">
                                        <a href="/moban/index.php/Home/Study/articleSearch/s/<?php echo ($s); ?>/p/<?php echo ($nex); ?>" title="下一页">下一页</a>
                                    </div>
                                    <?php endif;?>
                                <!--下一页结束-->
                            ...
                            <div class="page_right">
                                ...
                                <span class="page-small">
                                    ...
                                    /moban/index.php/Home/Study/articleSearch/s/<?php echo ($s); ?>/p/<?php echo ($pre); ?>
                                    <?php else:?>
                                        javascript:void(0)
                                    <?php endif;?>
                                    ">
                                    ...
                                    <?php if(!I('p')): $nex=2; ?>
                                     /moban/index.php/Home/Study/articleSearch/s/<?php echo ($s); ?>/p/<?php echo ($nex); ?>
