...
<script>
    var Thinkphp={
        'regist':"/moban/index.php/Home/Regist/regist",
    };
</script>
<body>
...
<div class="mainer">
    <div class="header">
        <div class="wrap">
            <h1><a href="http://www.dede58.com/" target="_parent" title="织梦模板_dedecms源码_DEDE58.COM">织梦58</a></h1>
            <div class="searchx">
                <div class="ss">
                    <div class="s_form">
                        <form name="formsearch" method="get" action="http://www.dede58.com/plus/search.php" target="_blank">
                            <input name="kwtype" value="0" type="hidden">
                            <input name="typeid" value="1" type="hidden">
                            <div class="s1">
                                <input class="keywords" name="q" id="q" title="请输入关键字" value="织梦58搜索..." onfocus="if(this.value=='织梦58搜索...'){this.value='';}" onblur="if(this.value==''){this.value='织梦58搜索...';}" maxlength="27" type="text">
                            </div>
                            <div class="s2">
                                <select name="typeid" class="search-option" id="typeid">
                                    <option value="0" selected="1">全部</option>

                                    <option value="1">VIP整站模板</option><option value="165">终身会员模板</option><option value="102">织梦学院</option><option value="117">织梦主机</option><option value="198">商业模板</option><option value="223">免费DEDE模板</option><option value="199">代理平台</option>
                    ...
                    <div class="s_b_link"><a href="http://www.dede58.com/vip/">每日更新</a>|<a href="http://www.dede58.com/vip/" rel="nofollow">每板必测</a>|<a href="http://www.dede58.com/" target="_top">Tag标签</a>|<a href="http://www.dede58.com/user/buy.php" rel="nofollow">充值</a></div>
                    <div class="cl"></div>
                </div>
            </div>
            ...
            <div class="s_rad">
                <ul>
                    <li><a href="http://www.dede58.com/shop/" style="color: rgb(255, 0, 0); font-weight: bold;"><b>织梦58商业模板频道上线！ </b></a></li>
                    <li><a href="http://www.dede58.com/a/dedecode/" style="color: red;">织梦会员模板，持续更新！</a></li>
                    <li><a href="http://www.dede58.com/host" style="color: rgb(62, 147, 26); font-weight: bold;"><b>免备案快速稳定空间热卖</b></a></li>
                </ul>
                <a href="http://www.dede58.com/user/mem_do.php?fmdo=login&amp;dopost=qiandao" title="随机增送5-12个金币，可用来购买商业模板" class="dayvip"></a>
            </div>
        </div>
    </div>
    <div class="nav_bg">
        <div class="wrap">
            <a class="qiandao" href="http://www.dede58.com/user/mem_do.php?fmdo=login&amp;dopost=qiandao" target="_self" title="随机增送5-12个金币，可用来购买商业模板">签到领金币！</a>
            <ul id="nav" class="nav clearfix">
                ...
                <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="nLi">
                    <h3><a href="http://www.dede58.com/a/dedecode/"><?php echo ($v['cate_name']); ?></a></h3>
...
<div class="reg">
        ...
        <div class="reg_mid">
                ...
                <div class="reg_mid_left">
                    <p>亲，您可以使用<span>以下帐号</span>直接登录模板易吧(moban18)，无需注册</p>
                ...
                <div class="reg_mid_right">
                    <div class="reg_mid_right_box">
                        ...
                        <div class="input_item">
                            <div id="username_title" class="item_title">用户名</div>
                            <input  id="username" type="text" class="form_input " name="username"/>
                            <span class="error" style="display:none;color:red;">不能为空</span>
                            <i class="right_igon" style="display:none"></i>
                            <span class='grey' style='display: none;'>允许用中英文、数字、下划线</span>
                        </div>
                        <div class="input_item">
                        ...
                        <div class="input_item">
                            <div id="password2_title" class="item_title ">确认密码</div>
                            <input id="password2"  type="password" class="form_input " name="password2"/>
                            <span class="error" style="display:none;color:red;">不能为空</span>
                            <i class="right_igon" style="display:none"></i>
                        </div>
                        <div class="input_item">
                            ...
                            <span class="error" style="display:none;color:red;">不能为空</span>
                            <i class="right_igon" style="display:none"></i>
                            <div class="verify_img"><img src="/moban/index.php/Home/Regist/veifiy_img" alt=""  onclick="this.src=this.src+'?'+Math.random();"/></div>
                        </div>



                        <a href="javascript:void(0);" class="formbottom">注册</a>
                    </div>
