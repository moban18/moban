...
<div id="main" class="clearfix">
                ...
                <div class="tg_classify_wrap clearfix ">
                    ...
                    <dl class="tg_classify_wrap_right">
                        ...
                        <dd class="<?php if(!I('filter') or $a[$ok]==0){echo 'on1';}?>">
                            ...
                            <a href="<?php
 if($filter=='0-0-0-0-0-0'){ echo U('Free/index'); }elseif(!I('filter')){ echo U('Free/index'); }else{ echo U('Free/index',['filter'=>$filter]); } ?>">
                                </span>不限</span>
                            </a>
                        </dd>
 ...
 if(!I('filter') or $feilei==0){ echo 'on1'; } if(in_array($feilei,$parent_ids)){ echo 'on1'; } ?>">
                            ...
                            <a href="<?php
 if($filter){ if(in_array($feilei,$parent_ids)){ $n[$ok]=$feilei; }else{ foreach($attrterss as $x){ if($feilei==$x['attrter_id']){ $n[$ok]=$x['attr_id']; } } } $filter=implode('-',$n); echo U('Free/index',['filter'=>$filter]); } ?>">
 ...
 if($L[$ok]<=0){ echo 'javascript:void(0);'; }else{ echo U('Free/index',['filter'=>$pre]); } ?>">
 ...
 if($L[$ok]>=$pages){ echo 'style="border-left: 5px solid #CCCCCC;"'; } ?>></span>
            ...
            <div id="list" class="list">
                <div class="list_box clearfix">
                    ...
                    <div class="goods_box">
                        <a href="/moban/index.php/Home/Free/content/id/<?php echo ($v['id']); ?>"><img src="/moban/<?php echo ($v['goods_photo']); ?>" alt=""/></a>
                        <p class="goods_title">
            ...
            <div class="page_list clearfix">
                ...
                <?php if(I('filter')){ $L=explode('-',I('filter')); $L[$ok]= $L[$ok]-1; $pre=implode('-',$L); }?>
                <a href="<?php
 if($L[$ok]<=0){ echo 'javascript:void(0);'; }else{ echo U('Free/index',['filter'=>$pre]); } ?>" class="pre">上一页</a>
