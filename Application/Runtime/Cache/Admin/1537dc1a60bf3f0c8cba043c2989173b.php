    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/moban/index.php/Admin/Cate/add'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td align="center">
                                                <input style="width:25px;text-align:center;" type="text" name="cate_sort" value="<?php echo ($v["cate_sort"]); ?>"/>
                                                <a href="#" class="btn btn-primary btn-sm shiny" onclick="cateSort(this)">
                                                    <i class="fa fa-edit"></i> 排序
                                                </a>

                                            </td>
                                            <td align="center">
                                                <a href="/moban/index.php/Admin/Cate/edit/id/<?php echo ($v["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="/moban/index.php/Admin/Cate/del/id/<?php echo ($v["id"]); ?>" onClick="if(confirm('确定要删除吗')==false)return false;" class="btn btn-danger btn-sm shiny">
...
<script>
    function cateSort(o){
        ...
        $.ajax({
            type:'post',
            url:'/moban/index.php/Admin/Cate/getSort',
            data:{
                sort:sort,
                id:cate_id,
            },
