    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li>
                    <a href="/admin/auth_group/index.html"><span class="menu-text"></span>
                        <i class="menu-expand"></i>
                    </a>
                </li>
                <li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="admin_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="admin_password" required="" type="password">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
