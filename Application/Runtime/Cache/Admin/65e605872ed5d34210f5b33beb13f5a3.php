    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加会员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/moban/index.php/Admin/User/add'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">会员EMAIL</th>
                                            <th class="text-center">会员昵称</th>
                                            <th class="text-center">会员种类</th>
                                        ...
                                        <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            <td align="center"><?php echo ($v["id"]); ?></td>
                                            <td align="center"><?php echo ($v["user_email"]); ?></td>
                                            <td align="center"><?php echo ($v["user_nick"]); ?></td>
                                            <td align="center"><?php echo ($v["vip_name"]); ?></td>
                                            <td align="center"><?php echo long2ip($v['log_ip']);?></td>
                                            <td align="center"><?php echo date('Y-m-d H:i:s',$v['log_time']);?></td>
                                            <td align="center"><?php echo ($v["log_num"]); ?></td>
                                            <td align="center"><?php echo date('Y-m-d H:i:s',$v['reg_time']);?></td>
                                            <td align="center">
                                                <?php if($v['user_lock'] == 1 ): ?>锁定
                                                    <?php else: ?>
                                                    无<?php endif; ?>
                                            </td>
                                            <td align="center">
                                                <a href="/moban/index.php/Admin/User/edit/id/<?php echo ($v["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="/moban/index.php/Admin/User/del/id/<?php echo ($v["id"]); ?>" onClick="if(confirm('确定要删除吗')==false)return false;" class="btn btn-danger btn-sm shiny">
