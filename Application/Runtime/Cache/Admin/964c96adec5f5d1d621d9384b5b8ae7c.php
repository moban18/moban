    ...
    <ul class="nav sidebar-menu">
        ...
        <li <?php if($ac == 'Attrtype' or $ac == 'Attr' or $ac == 'Attrs'): ?>class="open"<?php endif; ?> >
            ...
            <ul class="submenu">
                ...
                <li>
                    <a href="/moban/index.php/Admin/Attrs/index">
                                    <span class="menu-text">
                                        商品子属性管理                                    </span>
                        <i class="menu-expand"></i>
                    </a>
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加属性" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/moban/index.php/Admin/Attrs/add'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td align="center">
                                                <a href="/moban/index.php/Admin/Attrs/edit/id/<?php echo ($v["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="/moban/index.php/Admin/Attrs/del/id/<?php echo ($v["id"]); ?>" onClick="if(confirm('确定要删除吗')==false)return false;" class="btn btn-danger btn-sm shiny">
...
<script>
    function cateSort(o){
        ...
        $.ajax({
            type:'post',
            url:'/moban/index.php/Admin/Attrs/getSort',
            data:{
                sort:sort,
                id:cate_id,
            },
