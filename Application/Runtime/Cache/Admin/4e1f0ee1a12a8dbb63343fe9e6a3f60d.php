                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control"  name="user_email" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control"  placeholder="" name="user_nick" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">会员密码</label>
                            <div class="col-sm-2">
                                <input class="form-control"  name="user_password" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <select class="select" name="user_viptype">
                                    <?php if(is_array($vips)): $i = 0; $__LIST__ = $vips;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option <?php if($v['id'] == 1): ?>selected="selected"<?php endif; ?> value="<?php echo ($v['id']); ?>"><?php echo ($v["vip_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">*这里一般不选择，直接就这样</p>
                        </div>
