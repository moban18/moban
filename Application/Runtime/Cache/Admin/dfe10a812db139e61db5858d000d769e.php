    ...
    <form action="" method="post">
     ...
     <ul class="ulColumn2">
      <li>
       ...
       <input class="textbox textbox_225" name="name" type="text" value="<?php echo ($colors["color_name"]); ?>">
       <span class="errorTips">一般不超过6个字符</span>
      </li>

      <li>
       <span class="item_name" style="width:120px;">栏目排序：</span>
       <input name="sort" class="textbox textbox_225" value="<?php echo ($colors["sort"]); ?>" type="text">
