...
<script>
    ...
    function cateSort(o){
        ...
        $.ajax({
            type:'post',
            url:'/moban/index.php/Admin/Search/getSort',
            data:{
                sort:sort,
                id:cate_id,
            },
...
$('select[name=attrtype_id]').change(function(){
    ...
    $.ajax({
        type:'post',
        url:'/moban/index.php/Admin/Search/attrp',
        data:{
        ...
        success:function(data){
            ...
            $(a).each(function(k,v){
                ...
                html2+='<td align="center"> <a href="/moban/index.php/Admin/Search/edit/id/<?php echo ($v["id"]); ?>" class="btn btn-primary btn-sm shiny"> <i class="fa fa-edit"></i> 编辑 </a> <a href="/moban/index.php/Admin/Search/del/id/<?php echo ($v["id"]); ?>" onClick="if(confirm("确定要删除吗")==false)return false;" class="btn btn-danger btn-sm shiny"> <i class="fa fa-trash-o"></i> 删除 </a> </td> </tr>';
                html3+=html2;
            });
            html+='</select>'
            div.html(html);
    ...
    function getAttrs(o){
        ...
        $.ajax({
            type:'post',
            url:'/moban/index.php/Admin/Search/getAttres',
            data:{
                id:id
            },
            success:function(data){
                ...
                $(a).each(function(k,v){
                    ...
                    html+='<td align="center"> <a href="/moban/index.php/Admin/Search/edit/id/<?php echo ($v["id"]); ?>" class="btn btn-primary btn-sm shiny"> <i class="fa fa-edit"></i> 编辑 </a> <a href="/moban/index.php/Admin/Search/del/id/<?php echo ($v["id"]); ?>" onClick="if(confirm("确定要删除吗")==false)return false;" class="btn btn-danger btn-sm shiny"> <i class="fa fa-trash-o"></i> 删除 </a> </td> </tr>';
                    html1+=html;
                });
                tbody.html(html1);
            }
