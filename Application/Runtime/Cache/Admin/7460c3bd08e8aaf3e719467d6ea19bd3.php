...
<html><head>
    ...
    <style type="text/css">
        ...
        .goods_search_input{width:300px;height:25px;padding:2px 1px 2px 10px;}
        .goods_search_submit{background-color:#2BBBDF;color:#fff}
        .goods_search2{margin-left:10px;}
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <div class="goods_search">
                    ...
                    <input type="text" class="goods_search_input" name="goods_search"/>
                    <input type="submit" name="goods_search_sub" class="goods_search_submit btn btn-sm " value="查询"/>
                </div>
                <div class="goods_search2 float_left">
                    <span style="color:#2BBBDF">栏目商品搜索：</span>
                    <select class="goods_search_select">
                        <option>请选栏目</option>

                    </select>
                </div>
                <div class="goods_search2 float_left">
                    <span style="color:#2BBBDF">搜索设置数量：</span>
                    <select class="goods_search_select">
                        <option>搜索设置数</option>
                        <option>0</option>
                        <option>小于3</option>
