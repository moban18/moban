                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="admin_name" required="" type="text" value="<?php echo ($admins['admin_name']); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="留空则不修改密码" name="admin_password" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 为空表示不修改密码</p>
                        </div>
