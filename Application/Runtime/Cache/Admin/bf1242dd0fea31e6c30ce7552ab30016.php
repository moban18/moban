                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="/moban/index.php/Admin/Search/index">属性管理</a>
                    </li>
       ...
       $(document).ready(function(){
           ...
           $('input[name=attr_name]').blur(function(){
              var new_attr_name= $(this).val();
               ...
               if(new_attr_name!=attr_name){
                   $.ajax({
                       type:'post',
                       url:'/moban/index.php/Admin/Search/attrName',
                       data:{
                           id:id,
           ...
           $('#value_textarea').blur(function(){
               ...
               if(new_attr_value!=attr_value){
                   $.ajax({
                       type:'post',
                       url:'/moban/index.php/Admin/Search/attrValue',
                       data:{
                           id:id,
           ...
           $('input[name=attr_value1]').each(function(k,v){
              $(v).bind('blur',function(){
                  ...
                  $.ajax({
                      type:'post',
                      url:'/moban/index.php/Admin/Search/changeAttrter',
                      data:{
                          attr_id:attr_id,
                          attr_value:attr_value,
                      },
