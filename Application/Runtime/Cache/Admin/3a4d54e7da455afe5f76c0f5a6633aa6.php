...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">种类列表</h2>
   <a href="/moban/index.php/Admin/GoodsType/add" class="fr top_rt_btn add_icon">添加新种类</a>
  </div>
  ...
  <table class="table">
   ...
   <?php if(is_array($typeInfo)): $i = 0; $__LIST__ = $typeInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>

     <td class="center"><?php echo ($v["id"]); ?></td>
     <td class="center"><?php echo ($v["type_name"]); ?></td>

     <td class="center">
      <a href="/moban/index.php/Admin/GoodsType/edit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">e</a>
      <a href="/moban/index.php/Admin/GoodsType/del/id/<?php echo ($v["id"]); ?>" title="删除" onclick="return confirm('确定要删除吗？')" class="link_icon">d</a>
     </td>
