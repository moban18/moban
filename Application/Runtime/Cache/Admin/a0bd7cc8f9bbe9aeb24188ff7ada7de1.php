                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  value="<?php echo ($cates['cate_title']); ?>" name="cate_title" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo ($cates['cate_keywords']); ?>"  name="cate_keywords" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="cate_description" style="width:800px;min-height: 100px;"><?php echo ($cates['cate_description']); ?> </textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">栏目排序</label>
                            <div class="col-sm-1">
                                <input class="form-control"  placeholder="" name="cate_sort"  type="text" value="<?php echo ($cates['cate_sort']); ?>">
                            </div>
                            <p class="help-block col-sm-4 red"></p>
                        </div>
