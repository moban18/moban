...
<div id="main">
 ...
 <script>
   var Thinkphp={
     'edit':'/moban/index.php/Admin/Nav/edit',
 ...
 <div class="rt_content">
  ...
  <section>
      <input type="hidden" id="id" value="<?php echo ($navInfo["id"]); ?>"/>
   <ul class="ulColumn2">
    <li>
     <span class="item_name" style="width:120px;">栏目名称：</span>
     <input id="title" name="title" class="textbox textbox_225" value="<?php echo ($navInfo["title"]); ?>" type="text">
     <span class="errorTips">一般不超过6个字，12个字符</span>
    </li>
    <li>
     <span class="item_name" style="width:120px;">栏目链接：</span>
     <input id="url" name="url" class="textbox textbox_225" value="<?php echo ($navInfo["url"]); ?>" type="text">
     <span class="errorTips">一般不超过100个字符</span>
    </li>
    <li>
     <span class="item_name" style="width:120px;">栏目链接：</span>
     <label><input id="play" name="play" type="radio" <?php if($navInfo["display"] == 1): ?>checked="checked"<?php endif; ?>  value="1" >显示</label>
     <label><input id="play" name="play" type="radio" <?php if($navInfo["display"] == 0): ?>checked="checked"<?php endif; ?> value="0" >隐藏</label>
    </li>

    <li>
     <span class="item_name" style="width:120px;">栏目排序：</span>
     <input id="sort" class="textbox textbox_225" value="<?php echo ($navInfo["sort"]); ?>" type="text">
     <span class="errorTips">一般不超过3个字符</span>
    </li>

    <li>
     <span class="item_name" style="width:120px;"></span>
     <input class="link_btn_edit" value="保存" type="submit">
    </li>
   </ul>
