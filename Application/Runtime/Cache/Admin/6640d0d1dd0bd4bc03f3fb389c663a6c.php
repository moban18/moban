...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   ...
   <a href="/moban/index.php/Admin/Member/vipadd" class="fr top_rt_btn add_icon">添加新会员等级</a>
  </div>
  ...
  <table class="table">
   ...
   <?php if(is_array($vips)): $i = 0; $__LIST__ = $vips;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
     <td class="center"><?php echo ($v["id"]); ?></td>

     <td class="center"><?php echo ($v["vipname"]); ?></td>
     <td class="center"><?php echo ($v["viptype"]); ?></td>
     <td class="center"><?php echo ($v["viptime"]); ?> 天</td>
     <td class="center"><?php echo ($v["vipprice"]); ?> 元</td>

     <td class="center">
      <a href="/moban/index.php/Admin/Member/vipedit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">e</a>
      <a href="/moban/index.php/Admin/Member/vipdel/id/<?php echo ($v["id"]); ?>" title="删除" onclick="return confirm('确定要删除吗？')" class="link_icon">d</a>
     </td>
