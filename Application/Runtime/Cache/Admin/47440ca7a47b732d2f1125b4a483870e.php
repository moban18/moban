...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">会员等级编辑</h2>
  </div>
  <section>
   <div class="add_box">
    <form action="/moban/index.php/Admin/Member/vipedit" method="post">
     <input type="hidden" name="id" value="<?php echo ($vips["id"]); ?>"/>
     <ul class="ulColumn2">
      <li>
       <span class="item_name" style="width:120px;">等级名称：</span>
       <input class="textbox textbox_225" name="vipname" type="text" value="<?php echo ($vips["vipname"]); ?>">
       <span class="errorTips">一般不超过20个字符</span>
      </li>
      <li>
      <span class="item_name" style="width:120px;">等级类型：</span>
      <input class="textbox textbox_225" name="viptype" type="text" value="<?php echo ($vips["viptype"]); ?>">
      <span class="errorTips">一般不超过10个字符</span>
     </li>
      <li>
       <span class="item_name" style="width:120px;">等级时间：</span>
       <input class="textbox textbox_225" name="viptime"  type="text" value="<?php echo ($vips["viptime"]); ?>">
       <span class="errorTips">一般不超过10个字符</span>
      </li>
      <li>
       <span class="item_name" style="width:120px;">等级价格：</span>
       <input class="textbox textbox_225" name="vipprice"  type="text" value="<?php echo ($vips["vipprice"]); ?>">
       <span class="errorTips">一般不超过4个字符</span>
      </li>
      <li>
