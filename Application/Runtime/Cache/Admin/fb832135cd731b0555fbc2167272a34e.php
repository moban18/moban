...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">种类属性值列表</h2>
   <a href="/moban/index.php/Admin/Good/add" class="fr top_rt_btn add_icon">添加种类属性值</a>
  </div>
  ...
  <table class="table">
   ...
   <?php if(is_array($Attres)): $i = 0; $__LIST__ = $Attres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
     <td class="center"><?php echo ($v["id"]); ?></td>
    <td class="center"><?php echo ($v["attrs_name"]); ?></td>
     <td class="center"><?php echo ($v["attrname"]); ?></td>

     <td class="center">
      <a href="/moban/index.php/Admin/Good/edit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">e</a>
      <a href="/moban/index.php/Admin/Good/del/id/<?php echo ($v["id"]); ?>" title="删除" onclick="return confirm('确定要删除吗？')" class="link_icon">d</a>
     </td>
