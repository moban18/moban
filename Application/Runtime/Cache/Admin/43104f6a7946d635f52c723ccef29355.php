...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">行业列表</h2>
   <a href="/moban/index.php/Admin/GoodsIndustry/add" class="fr top_rt_btn add_icon">添加新行业</a>
  </div>
  ...
  <table class="table">
   ...
   <?php if(is_array($inds)): $i = 0; $__LIST__ = $inds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
     ...
     <td class="center">
      <a href="/moban/index.php/Admin/GoodsIndustry/edit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">e</a>
      <a href="/moban/index.php/Admin/GoodsIndustry/del/id/<?php echo ($v["id"]); ?>" title="删除" onclick="return confirm('确定要删除吗？')" class="link_icon">d</a>
     </td>
