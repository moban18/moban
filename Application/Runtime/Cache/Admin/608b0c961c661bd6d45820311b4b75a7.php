                            ...
                            <div class="widget-body">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" name="goods_name" required="" type="text" value="<?php echo ($goodss['goods_name']); ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cate_id" id="cate_id" class="selected">
                                                    <option>选择栏目</option>
                                                    <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option <?php if($v['id'] == $goodss['cate_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($v['id']); ?>"><?php echo ($v['cate_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="goods_auth" class="form-group" style="margin-top:10px;">
                                            ...
                                            <?php foreach($vips as $v): if(in_array($v['id'],$goods_vips)){ $checked='checked="checked"'; }else{ $checked=''; } ?>
                                            <div class="col-lg-1 col-sm-1 col-xs-1"> <div class="checkbox"> <label> <input type="checkbox" class="colored-blue" name="goods_vips[]" value="<?php echo ($v['id']); ?>" <?php echo $checked;?> > <span class="text" style="color:#036F9E"><?php echo ($v['vip_name']); ?></span> </label> </div> </div>
                                            <?php endforeach;?>
                                        </div>
                                        <?php endif;?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="attrtype_id" id="attrtype_id" class="selected">
                                                    <option>选择种类</option>
                                                    <?php if(is_array($attrtypes)): $i = 0; $__LIST__ = $attrtypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option <?php if($v['id'] == $goodss['attrtype_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($v['id']); ?>"><?php echo ($v['attrtype_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" style="margin-top:10px;" >
                                            ...
                                            <div class="col-sm-1">
                                                <input class="form-control"  placeholder="" name="goods_comment" required="" type="text" value="<?php echo ($goodss['goods_comment']); ?>">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-sm-1">
                                                <input class="form-control"  placeholder="" name="goods_store" required="" type="text" value="<?php echo ($goodss['goods_store']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-1">
                                                <input class="form-control"  placeholder="" name="goods_recommend" required="" type="text" value="<?php echo ($goodss['goods_recommend']); ?>">
                                        ...
                                        <div class="form-group " style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-1">
                                                <input class="form-control"  placeholder="" name="download_num" required="" type="text" value="<?php echo ($goodss['download_num']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control"  placeholder="" name="goods_author" required="" type="text" value="<?php echo ($goodss['goods_author']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control"  placeholder="" name="goods_view" required="" type="text" value="<?php echo ($goodss['goods_view']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control"  placeholder="" name="download_url" required="" type="text" value="<?php echo ($goodss['download_url']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control"  placeholder="" name="code_url" required="" type="text" value="<?php echo ($goodss['code_url']); ?>">
                                        ...
                                        <div class="form-group" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea id='goods_content' name="goods_content"><?php echo ($goodss['goods_content']); ?></textarea>
                                            </div>
                                        </div>
