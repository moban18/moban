    ...
    <form action="" method="post">
     <ul class="ulColumn2">
      <li>
       ...
       <input class="textbox textbox_225" name="vipname" type="text">
       <span class="errorTips">一般不超过20个字符</span>
      </li>
      <li>
      <span class="item_name" style="width:120px;">等级类型：</span>
      <input class="textbox textbox_225" name="viptype" type="text">
      <span class="errorTips">一般不超过10个字符</span>
     </li>
      <li>
       <span class="item_name" style="width:120px;">等级时间：</span>
       <input class="textbox textbox_225" name="viptime"  type="text">
       <span class="errorTips">一般不超过10个字符</span>
      </li>
      <li>
       <span class="item_name" style="width:120px;">等级价格：</span>
       <input class="textbox textbox_225" name="vipprice"  type="text">
