...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">行业编辑</h2>
   <a href="/moban/index.php/Admin/GoodsIndustry/index" class="fr top_rt_btn add_icon">行业列表</a>
  </div>
  <section>
   <div class="add_box">
    <form action="" method="post">
     <input type="hidden" name="id" value="<?php echo ($inds["id"]); ?>"/>
     <ul class="ulColumn2">
      <li>
       <span class="item_name" style="width:120px;">行业名称：</span>
       <input class="textbox textbox_225" name="name" type="text" value="<?php echo ($inds["name"]); ?>">
       <span class="errorTips">一般不超过20个字符</span>
      </li>
      <li>
       <span class="item_name" style="width:120px;">栏目链接：</span>
       <label><input  name="top" type="radio" <?php if($inds["top"] == 1): ?>checked="checked"<?php endif; ?>  value="1" >推荐</label>
       <label><input name="top" type="radio" <?php if($inds["top"] == 0): ?>checked="checked"<?php endif; ?> value="0" >不推荐</label>
      </li>

      <li>
       <span class="item_name" style="width:120px;">栏目排序：</span>
       <input name="sort" class="textbox textbox_225" value="<?php echo ($inds["sort"]); ?>" type="text">
