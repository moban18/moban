            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($luns["id"]); ?>"/>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">轮播名称：</label>
                            <div class="col-sm-4">
                                <input class="form-control"  name="lun_name" required="" type="text" value="<?php echo ($luns["lun_name"]); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="lun_notise" style="width:340px;"><?php echo ($luns["lun_notise"]); ?></textarea>
                            </div>
                        ...
                        <div class="form-group" style="clear:both;">
                            ...
                            <p class="help-block col-sm-4 red">* 多张图片，直接选择多张</p>
                            <div id="addPhotos" style="clear:both;margin-left:18%;">

                                <?php $lunPhotos=explode(',',$luns['lun_photos']); foreach($lunPhotos as $v): ?>
                                <div class="img_photo_box">
                                    <img class="img_phpoto" name="lun_photos[]" src="/moban/<?php echo ($v); ?>" alt="<?php echo ($v); ?>" style="opacity: 1;">
                                    <i class="close_icon" style="left: 376px; top: 0px; display: none;"></i>
                                </div>
                                <input name="lun_photos[]" class="lun_photos" value="<?php echo ($v); ?>" type="hidden">
                                <?php endforeach;?>
                            </div>
                       </div>
                        <div id="goods_links_box">
                            <?php
 if($luns['goods_links']){ $goods_links=explode(',',$luns['goods_links']); } ?>
                            <?php foreach($goods_links as $v1):?>
                                    ...
                                    <label>
                                        <select name="goods_links[]">
                                            ...
                                            <option value="<?php echo ($v['id']); ?>"
                                             <?php if($v['id']==$v1){ echo $select='selected="selected"'; } ?>
                                            ><?php echo ($v['id']); ?>、<?php echo ($v['goods_name']); ?></option>
                                            <?php endforeach;?>
                                        </select>
                        ...
                        <div class="form-group" style="clear:both;">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    <input class="checkbox-slider yesno" name="lun_lock" value="1" type="checkbox" <?php if($luns['lun_lock'] == 1): ?>checked='checked'<?php endif; ?> >
                                    <span class="text"></span>
                                </label>
                            </div>
                        </div>
    ...
    <script>
            ...
            /*$('.close_icon').click(function(){
                var div1 =$(this).parent('.img_photo_box');
                var path=div1.find('.img_phpoto').attr('alt');
                alert(path);
                $.ajax({
                    type:'post',
