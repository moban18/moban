...
<div id="main">
 ...
 <div class="rt_content">
  <div class="page_title">
   <h2 class="fl">商品颜色管理</h2>
   <a href="/moban/index.php/Admin/GoodsColor/index" class="fr top_rt_btn add_icon">颜色列表</a>
  </div>
  <section>
   <div class="add_box">
    <form action="" method="post">
     <ul class="ulColumn2">
      <li>
       <span class="item_name" style="width:120px;">颜色名称：</span>
       <input id="title" name="color_name" class="textbox textbox_225" placeholder="颜色名称..." type="text">
       <span class="errorTips">不超过3个字，6个字符</span>
      </li>
      <li>
       <span class="item_name" style="width:120px;"></span>
       <input class="member_btn" value="添加" type="submit">
      </li>
     </ul>
    </form>
   </div>
